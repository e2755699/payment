...
class OP_Openpayccard24_Model_Main extends Mage_Payment_Model_Method_Abstract

{
	...
	* @var string [a-z0-9_]
	**/
	protected $_code = 'openpayccard24_main';
    ...
    {
          return Mage::getUrl('openpayccard24/processing/redirect');
    }
    ...
    $iid = '12';
    	$params = 	array(
            ...
            'cname'	=>	$cname,
            'xname'	=>	$xname,
						'return_url'	=> Mage::getUrl('openpayccard24/processing/response')
    				);
    	return $params;
    }
