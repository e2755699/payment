...
class OP_Openpayccard03_ProcessingController extends Mage_Core_Controller_Front_Action
{
    protected $_successBlockType = 'openpayccard03/success';
    protected $_failureBlockType = 'openpayccard03/failure';
    protected $_cancelBlockType = 'openpayccard03/cancel';
    ...
    public function responseAction()
    {
		...
		$p1 = Mage::getModel('OP_Openpayccard03_Model_Main')->getConfigData('p1');	
    $p2 = Mage::getModel('OP_Openpayccard03_Model_Main')->getConfigData('p2');	
    $mid = Mage::getModel('OP_Openpayccard03_Model_Main')->getConfigData('mid');	
    ...
    {
        return Mage::helper('openpayccard03')->getPendingPaymentStatus();
    }
}
