...
class OP_Openpayccard00_ProcessingController extends Mage_Core_Controller_Front_Action
{
    protected $_successBlockType = 'openpayccard00/success';
    protected $_failureBlockType = 'openpayccard00/failure';
    protected $_cancelBlockType = 'openpayccard00/cancel';
    ...
    public function responseAction()
    {
		...
		$p1 = Mage::getModel('OP_Openpayccard00_Model_Main')->getConfigData('p1');	
    $p2 = Mage::getModel('OP_Openpayccard00_Model_Main')->getConfigData('p2');	
    $mid = Mage::getModel('OP_Openpayccard00_Model_Main')->getConfigData('mid');	
    ...
    {
        return Mage::helper('openpayccard00')->getPendingPaymentStatus();
    }
}