...
class OP_Openpayccard06_ProcessingController extends Mage_Core_Controller_Front_Action
{
    protected $_successBlockType = 'openpayccard06/success';
    protected $_failureBlockType = 'openpayccard06/failure';
    protected $_cancelBlockType = 'openpayccard06/cancel';
    ...
    public function responseAction()
    {
		...
		$p1 = Mage::getModel('OP_Openpayccard06_Model_Main')->getConfigData('p1');	
    $p2 = Mage::getModel('OP_Openpayccard06_Model_Main')->getConfigData('p2');	
    $mid = Mage::getModel('OP_Openpayccard06_Model_Main')->getConfigData('mid');	
    ...
    {
        return Mage::helper('openpayccard06')->getPendingPaymentStatus();
    }
}
