...
class OP_Openpayccard24_ProcessingController extends Mage_Core_Controller_Front_Action
{
    protected $_successBlockType = 'openpayccard24/success';
    protected $_failureBlockType = 'openpayccard24/failure';
    protected $_cancelBlockType = 'openpayccard24/cancel';
    ...
    public function responseAction()
    {
		...
		$p1 = Mage::getModel('OP_Openpayccard24_Model_Main')->getConfigData('p1');	
    $p2 = Mage::getModel('OP_Openpayccard24_Model_Main')->getConfigData('p2');	
    $mid = Mage::getModel('OP_Openpayccard24_Model_Main')->getConfigData('mid');	
    ...
    {
        return Mage::helper('openpayccard24')->getPendingPaymentStatus();
    }
}
