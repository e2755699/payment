...
class OP_Openpayccard00_Model_Main extends Mage_Payment_Model_Method_Abstract

{
	...
	* @var string [a-z0-9_]
	**/
	protected $_code = 'openpayccard00_main';
    ...
    {
          return Mage::getUrl('openpayccard00/processing/redirect');
    }
    ...
    $iid = '0';
    	$params = 	array(
            ...
            'cname'	=>	$cname,
            'xname'	=>	$xname,
						'return_url'	=> Mage::getUrl('openpayccard00/processing/response')
    				);
    	return $params;
    }
