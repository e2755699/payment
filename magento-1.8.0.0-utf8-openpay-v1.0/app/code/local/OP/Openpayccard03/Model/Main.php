...
class OP_Openpayccard03_Model_Main extends Mage_Payment_Model_Method_Abstract

{
	...
	* @var string [a-z0-9_]
	**/
	protected $_code = 'openpayccard03_main';
    ...
    {
          return Mage::getUrl('openpayccard03/processing/redirect');
    }
    ...
    $iid = '3';
    	$params = 	array(
            ...
            'cname'	=>	$cname,
            'xname'	=>	$xname,
						'return_url'	=> Mage::getUrl('openpayccard03/processing/response')
    				);
    	return $params;
    }
