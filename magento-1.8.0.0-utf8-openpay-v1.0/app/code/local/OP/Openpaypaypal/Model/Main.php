...
class OP_Openpaypaypal_Model_Main extends Mage_Payment_Model_Method_Abstract

{
	...
	* @var string [a-z0-9_]
	**/
	protected $_code = 'openpaypaypal_main';
    ...
    {
          return Mage::getUrl('openpaypaypal/processing/redirect');
    }
    ...
    $txid = $this->getOrder()->getRealOrderId(); //賣家交易單號
    	...
    	$params = 	array(
            ...
            'cname'	=>	$cname,
            'xname'	=>	$xname,
						'return_url'	=> Mage::getUrl('openpaypaypal/processing/response')
    				);
    	return $params;
    }
