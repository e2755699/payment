...
class OP_Openpayccard36_Model_Main extends Mage_Payment_Model_Method_Abstract

{
	...
	* @var string [a-z0-9_]
	**/
	protected $_code = 'openpayccard36_main';
    ...
    {
          return Mage::getUrl('openpayccard36/processing/redirect');
    }
    ...
    $iid = '36';
    	$params = 	array(
            ...
            'cname'	=>	$cname,
            'xname'	=>	$xname,
						'return_url'	=> Mage::getUrl('openpayccard36/processing/response')
    				);
    	return $params;
    }
