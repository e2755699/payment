...
class OP_Openpayccard36_ProcessingController extends Mage_Core_Controller_Front_Action
{
    protected $_successBlockType = 'openpayccard36/success';
    protected $_failureBlockType = 'openpayccard36/failure';
    protected $_cancelBlockType = 'openpayccard36/cancel';
    ...
    public function responseAction()
    {
		...
		$p1 = Mage::getModel('OP_Openpayccard36_Model_Main')->getConfigData('p1');	
    $p2 = Mage::getModel('OP_Openpayccard36_Model_Main')->getConfigData('p2');	
    $mid = Mage::getModel('OP_Openpayccard36_Model_Main')->getConfigData('mid');	
    ...
    {
        return Mage::helper('openpayccard36')->getPendingPaymentStatus();
    }
}
